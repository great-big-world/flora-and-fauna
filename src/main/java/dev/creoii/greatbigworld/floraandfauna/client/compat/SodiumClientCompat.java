...
public final class SodiumClientCompat {
    public static void rebuildSeason(MinecraftClient client) {
        if (client.world != null) {
            RenderSectionManager renderSectionManager = ((SodiumWorldRendererAccessor) ((LevelRendererExtension) client.worldRenderer).sodium$getWorldRenderer()).gbw$getRenderSectionManager();
