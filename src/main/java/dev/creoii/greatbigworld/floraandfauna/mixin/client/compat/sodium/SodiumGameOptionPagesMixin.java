...
public class SodiumGameOptionPagesMixin {
    ...
    private static OptionGroup.Builder gbw$addSodiumSeasonTransitionQualityOption(OptionGroup.Builder original) {
        return original.add(OptionImpl.createBuilder(TransitionQuality.class, vanillaOpts).setName(Text.translatable("options.seasonTransitionQuality")).setTooltip(Text.empty()).setControl(option -> new CyclingControl<>(option, TransitionQuality.class, TransitionQuality.NAMES)).setBinding((opts, value) -> {
