...
public final class FloraAndFaunaBlocks {
    public static final Block HUMUS = new SnowyBlock(FabricBlockSettings.copy(Blocks.GRASS_BLOCK).mapColor(MapColor.TERRACOTTA_BROWN));
    public static final Block MOSS_CARPET = new MossCarpetBlock(FabricBlockSettings.copy(Blocks.MOSS_CARPET));
    public static final Block TROPICAL_FERN = new ShortPlantBlock(FabricBlockSettings.copy(Blocks.FERN));
    ...
    public static final Block RED_HIBISCUS = new FlowerBlock(StatusEffects.NAUSEA, 0, FabricBlockSettings.copy(Blocks.DANDELION));
    public static final Block ORANGE_HIBISCUS = new FlowerBlock(StatusEffects.NAUSEA, 0, FabricBlockSettings.copy(Blocks.DANDELION));
    public static final Block YELLOW_HIBISCUS = new FlowerBlock(StatusEffects.NAUSEA, 0, FabricBlockSettings.copy(Blocks.DANDELION));
    public static final Block BLUE_HIBISCUS = new FlowerBlock(StatusEffects.NAUSEA, 0, FabricBlockSettings.copy(Blocks.DANDELION));
    public static final Block PINK_HIBISCUS = new FlowerBlock(StatusEffects.NAUSEA, 0, FabricBlockSettings.copy(Blocks.DANDELION));
    public static final Block PURPLE_HIBISCUS = new FlowerBlock(StatusEffects.NAUSEA, 0, FabricBlockSettings.copy(Blocks.DANDELION));
    public static final Block BLACK_HIBISCUS = new FlowerBlock(StatusEffects.NAUSEA, 0, FabricBlockSettings.copy(Blocks.DANDELION));
    public static final Block WHITE_HIBISCUS = new FlowerBlock(StatusEffects.NAUSEA, 0, FabricBlockSettings.copy(Blocks.DANDELION));
    public static final Block POTTED_RED_HIBISCUS = new FlowerPotBlock(RED_HIBISCUS, FabricBlockSettings.copy(Blocks.FLOWER_POT));
    public static final Block POTTED_ORANGE_HIBISCUS = new FlowerPotBlock(ORANGE_HIBISCUS, FabricBlockSettings.copy(Blocks.FLOWER_POT));
    public static final Block POTTED_YELLOW_HIBISCUS = new FlowerPotBlock(YELLOW_HIBISCUS, FabricBlockSettings.copy(Blocks.FLOWER_POT));
    public static final Block POTTED_BLUE_HIBISCUS = new FlowerPotBlock(BLUE_HIBISCUS, FabricBlockSettings.copy(Blocks.FLOWER_POT));
    public static final Block POTTED_PINK_HIBISCUS = new FlowerPotBlock(PINK_HIBISCUS, FabricBlockSettings.copy(Blocks.FLOWER_POT));
    public static final Block POTTED_PURPLE_HIBISCUS = new FlowerPotBlock(PURPLE_HIBISCUS, FabricBlockSettings.copy(Blocks.FLOWER_POT));
    public static final Block POTTED_BLACK_HIBISCUS = new FlowerPotBlock(BLACK_HIBISCUS, FabricBlockSettings.copy(Blocks.FLOWER_POT));
    public static final Block POTTED_WHITE_HIBISCUS = new FlowerPotBlock(WHITE_HIBISCUS, FabricBlockSettings.copy(Blocks.FLOWER_POT));
    ...
    public static final Block HOLLOW_CHERRY_LOG = new HollowLogBlock(FabricBlockSettings.copy(Blocks.CHERRY_LOG));
    public static final Block HOLLOW_WARPED_STEM = new HollowLogBlock(FabricBlockSettings.copy(Blocks.WARPED_STEM));
    public static final Block HOLLOW_CRIMSON_STEM = new HollowLogBlock(FabricBlockSettings.copy(Blocks.CRIMSON_STEM));
    ...
    public static final Block STRIPPED_HOLLOW_CHERRY_LOG = new HollowLogBlock(FabricBlockSettings.copy(Blocks.STRIPPED_CHERRY_LOG));
    public static final Block STRIPPED_HOLLOW_WARPED_STEM = new HollowLogBlock(FabricBlockSettings.copy(Blocks.STRIPPED_WARPED_STEM));
    public static final Block STRIPPED_HOLLOW_CRIMSON_STEM = new HollowLogBlock(FabricBlockSettings.copy(Blocks.STRIPPED_CRIMSON_STEM));
    public static final Block ALGAE = new AlgaeBlock(FabricBlockSettings.copy(Blocks.LILY_PAD));
